...
const routes = {
  ...
  'personal.personal_diario': {
    ...
    tokens: [{"old":"/api/v1/dashboard/personal/diario","type":0,"val":"api","end":""},{"old":"/api/v1/dashboard/personal/diario","type":0,"val":"v1","end":""},{"old":"/api/v1/dashboard/personal/diario","type":0,"val":"dashboard","end":""},{"old":"/api/v1/dashboard/personal/diario","type":0,"val":"personal","end":""},{"old":"/api/v1/dashboard/personal/diario","type":0,"val":"diario","end":""}],
    types: placeholder as Registry['personal.personal_diario']['types'],
  },
  'personal.personal_semanal': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/dashboard/personal/semanal',
    tokens: [{"old":"/api/v1/dashboard/personal/semanal","type":0,"val":"api","end":""},{"old":"/api/v1/dashboard/personal/semanal","type":0,"val":"v1","end":""},{"old":"/api/v1/dashboard/personal/semanal","type":0,"val":"dashboard","end":""},{"old":"/api/v1/dashboard/personal/semanal","type":0,"val":"personal","end":""},{"old":"/api/v1/dashboard/personal/semanal","type":0,"val":"semanal","end":""}],
    types: placeholder as Registry['personal.personal_semanal']['types'],
  },
  ...
  'test.send': {
    ...
    tokens: [{"old":"/api/v1/test-mail","type":0,"val":"api","end":""},{"old":"/api/v1/test-mail","type":0,"val":"v1","end":""},{"old":"/api/v1/test-mail","type":0,"val":"test-mail","end":""}],
